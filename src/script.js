...
// coment let valor01 = 0
// coment let valor02 = 0
// coment let telavalorresult = ''
let operador = ['-', '+', '/', '*']
let operadores = ['-', '+', '/', '*', '.', ""]
...
let lista_de_button = document.getElementsByClassName('numeral')
...
let bota_somar = document.getElementsByClassName("operacao soma");
...
let bota_multiplicar = document.getElementsByClassName("operacao multiplicador");
...
let bota_dividir = document.getElementsByClassName("operacao divisor");
...
function PodeAdicionar(){
    ...
    var valor_do_operador = valor.replace(/\d+/g,'') //ignorar num
...
function Resolver(){
    try{
        ...
        document.getElementById("resultado").value = "Erro na operação"
    }
